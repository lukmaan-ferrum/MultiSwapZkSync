...
export interface WithAdminInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "admin"
      | "owner"
...
export interface WithAdmin extends BaseContract {
  connect(runner?: ContractRunner | null): WithAdmin;
  waitForDeployment(): Promise<this>;

  interface: WithAdminInterface;

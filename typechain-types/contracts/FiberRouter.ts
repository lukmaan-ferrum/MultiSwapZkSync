...
export interface FiberRouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "gasWallet"
...
export interface FiberRouter extends BaseContract {
  connect(runner?: ContractRunner | null): FiberRouter;
  waitForDeployment(): Promise<this>;

  interface: FiberRouterInterface;

...
export interface ForgeFundManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "NAME"
      | "VERSION"
...
export interface ForgeFundManager extends BaseContract {
  connect(runner?: ContractRunner | null): ForgeFundManager;
  waitForDeployment(): Promise<this>;

  interface: ForgeFundManagerInterface;
